...
#ifndef DROPBOXSIGNONSYNCADAPTOR_H
#define DROPBOXSIGNONSYNCADAPTOR_H
...
class DropBoxSignonSyncAdaptor : public DropBoxDataTypeSyncAdaptor
{
    Q_OBJECT

public:
    DropBoxSignonSyncAdaptor(QObject *parent);
    ~DropBoxSignonSyncAdaptor();
...
#endif // DROPBOXSIGNONSYNCADAPTOR_H

...
FacebookNotificationPage {
    ...
    property bool liked
    property QtObject commentsModel: facebookComments
    property QtObject likesModel: facebookLikes
    property string error

    Component.onCompleted: populateCommentsAndLikes()
    onReadyToPopulateChanged: populateCommentsAndLikes()
    onNodeIdentifierChanged: populateCommentsAndLikes()
    ...
    SocialNetworkModel {
        ...
        onErrorChanged: console.log("Facebook comments network model error: " + error + "\n")
        onErrorMessageChanged: console.log("Facebook comments network model error message: " + errorMessage + "\n")
    }
    ...
    function populateCommentsAndLikes() {
        if (readyToPopulate) {
            facebookComments.nodeIdentifier = container.nodeIdentifier

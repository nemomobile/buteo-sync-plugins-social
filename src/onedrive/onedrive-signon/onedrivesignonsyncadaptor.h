...
#ifndef ONEDRIVESIGNONSYNCADAPTOR_H
#define ONEDRIVESIGNONSYNCADAPTOR_H
...
class OneDriveSignonSyncAdaptor : public OneDriveDataTypeSyncAdaptor
{
    Q_OBJECT

public:
    OneDriveSignonSyncAdaptor(QObject *parent);
    ~OneDriveSignonSyncAdaptor();
...
#endif // ONEDRIVESIGNONSYNCADAPTOR_H
